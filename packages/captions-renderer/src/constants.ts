...
/**
 * Spans comes with a default padding in order to give a better reading experience
 * when background colors are set. Use this to customize the padding of the spans.
 */
